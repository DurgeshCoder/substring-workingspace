...
export default function CorrectionClient({ initialCorrections, initialLeaves }: CorrectionClientProps) {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      <div>
        <h1 className="text-2xl font-bold text-foreground">Corrections & Leaves</h1>
        <p className="text-xs text-muted-foreground">
          Approve or reject employee requests for check-in/out hour corrections and leaves.
        </p>
      </div>

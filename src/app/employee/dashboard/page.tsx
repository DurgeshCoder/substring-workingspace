...
export default function EmployeeDashboardPage() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-300">
      ...
      {/* Top Welcome Banner */}
      <div className="bg-gradient-to-r from-fuchsia-900/40 via-indigo-900/10 to-slate-900/50 border border-slate-800 rounded-2xl p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-xl">
        ...
        <div className="lg:col-span-1 bg-slate-900 border border-slate-800/80 rounded-2xl p-6 space-y-4 shadow-md flex flex-col justify-between">
          ...
          <div className="space-y-2.5">
            ...
            >
              ...
              <ArrowRight className="w-4 h-4 text-slate-500 group-hover:text-fuchsia-400 group-hover:translate-x-0.5 transition-all" />
            </Link>
            <Link 
